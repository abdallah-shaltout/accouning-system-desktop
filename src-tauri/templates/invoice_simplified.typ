// Simplified (B2C) tax invoice — docs/v2/12-documents-pdf-excel.md §3.
// Same layout as the standard invoice; the simplified flag mainly affects
// what the Vue side chooses as the default template and locks the QR on.
