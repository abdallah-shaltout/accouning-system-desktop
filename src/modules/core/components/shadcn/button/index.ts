...
// No focus-visible:ring/border-ring on the base class — the app's single global :focus-visible
// rule (design-system.css) already draws the two-tone ring for every control, including buttons.
