...
status: open
area: onboarding
fingerprint: e2e:onboarding:crash:  - waiting for get_by_label("الدولة")
first_seen: 2026-09-26
last_seen: 2026-09-26
occurrences: 2
---

## onboarding flow crashed (unhandled exception):   - waiting for get_by_label("الدولة")
...
Traceback (most recent call last):
  ...
  File "H:\storage\porjcets\invoice-generator\desktop-app\scripts\e2e\flows\onboarding.py", line 111, in run
    page.get_by_label("الدولة").select_option("SA")
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^
  File "C:\Users\abdal\AppData\Local\Python\pythoncore-3.14-64\Lib\site-packages\playwright\sync_api\_generated.py", line 19842, in select_option
    self._sync(
    ~~~~~~~~~~^
  ...
  File "C:\Users\abdal\AppData\Local\Python\pythoncore-3.14-64\Lib\site-packages\playwright\_impl\_sync_base.py", line 115, in _sync
    return task.result()
           ~~~~~~~~~~~^^
  File "C:\Users\abdal\AppData\Local\Python\pythoncore-3.14-64\Lib\site-packages\playwright\_impl\_locator.py", line 628, in select_option
    return await self._frame.select_option(
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...<3 lines>...
    )
    ^
  File "C:\Users\abdal\AppData\Local\Python\pythoncore-3.14-64\Lib\site-packages\playwright\_impl\_frame.py", line 808, in select_option
...
playwright._impl._errors.Error: Locator.select_option: Error: strict mode violation: get_by_label("الدولة") resolved to 2 elements:
