...
status: open
area: onboarding
fingerprint: e2e:onboarding:crash:  - waiting for get_by_role("button", name="متابعة")
first_seen: 2026-09-26
last_seen: 2026-09-26
occurrences: 1
---

## onboarding flow crashed (unhandled exception):   - waiting for get_by_role("button", name="متابعة")
...
Traceback (most recent call last):
  ...
  File "H:\storage\porjcets\invoice-generator\desktop-app\scripts\e2e\flows\onboarding.py", line 159, in run
...
Call log:
  - waiting for get_by_role("button", name="متابعة")
